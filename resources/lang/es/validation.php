...
return [
    ...
    */
    ...
    'custom' => [
        ...
        'valorAllBy'    => [
            'required_if' => 'Debe ingresar el valor a cobrar para la opción "Todos los envíos Cuestan".',
        ],
        'valorFreeFrom'    => [
            'required_if' => 'Debe ingresar el valor a cobrar para la opción "Es Gratis si la compra supera los".',
        ],
        'minimoFreeFrom'    => [
            'required_if' => 'Debe ingresar el valor donde no se cobra envío para la opción "Es Gratis si la compra supera los".',
        ],
    ],
    ...
    */
    ...
    'attributes' => [
        ...
        'valorAllBy'            => 'valor a cobrar para la opción "Todos los envíos Cuestan"',
        'valorFreeFrom'         => 'valor a cobrar para la opción "Es Gratis si la compra supera los"',
        'minimoFreeFrom'        => 'valor donde no se cobra envío para la opción "Es Gratis si la compra supera los"',
        'code'                  => 'código',
        'category'              => 'categoría',
        'featured'              => 'destacado',
        'sell_without_stock'    => 'vender sin existencia de productos',
        'show_stock'            => 'mostrar inventario',
