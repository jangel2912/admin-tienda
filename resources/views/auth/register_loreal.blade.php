...
<div class="elementor-image">
    <img height="100" src="/img/logo_loreal.png" alt="Loreal logo"  style="padding-right: 20px;" />
...
<div class="elementor-widget-container">
    <h2 class="elementor-heading-title">Exclusivo para clientes Loreal</h2>
</div>
<div class="container">
    <div class="panel panel-default">
        <div class="panel-heading">
            <h1 class="title">Pruébalo Gratis 14 Días</h1>
        ...
        <div class="panel-body">
            <form id="shopForm" class="form-horizontal" role="form" method="POST" action="{{ route('register') }}">
                ...
                <div class="row">
                    ...
                    <input type="hidden" class="form-element" name="ally" value="loreal" />
