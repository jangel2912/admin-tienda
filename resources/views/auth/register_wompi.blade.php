...
<div class="elementor-image">
    <img height="60" src="/img/logo_bancolombia.png" alt="Bancolombia logo"  style="padding-right: 20px;" />
...
<div class="elementor-widget-container">
    <h2 class="elementor-heading-title">Exclusivo para clientes Bancolombia</h2>
</div>
<div class="container">
        ...
        <div class="panel-body">
            <form id="shopForm" class="form-horizontal" role="form" method="POST" action="{{ route('register') }}">
                ...
                <div class="row">
                    ...
                    <input type="hidden" class="form-element" name="ally" value="wompi" />
