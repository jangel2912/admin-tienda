...
@section('panel-content')
    @if(!is_null($promotion))
        <div class="alert alert-warning">
            <h4>¡Advertencia!</h4>
            <p>Actualmente esta activada la promoción <b>{{ $promotion->nombre }}</b>. Si activa una nueva promoción, se desactivara automaticamente la promoción <b>{{ $promotion->nombre }}.</b></p>
        </div>
    @endif
    @include('admin.partials.alerts')
    <ul class="nav nav-tabs">
        <li role="presentation"><a href="{{ route('admin.promotions.index') }}">Lista de Promociones</a></li>
        <li role="presentation" class="active"><a href="#">Nueva Promoción</a></li>
    </ul>
        ...
        <div class="row">
            <div class="col-md-6">
                <div class="form-group {{ $errors->has('initial_date') ? 'has-error' : '' }}">
                    ...
                    <input type="date" id="initial_date" name="initial_date" value="{{ old('initial_date') }}" class="form-control" required>
            ...
            <div class="col-md-6">
                <div class="form-group {{ $errors->has('initial_time') ? 'has-error' : '' }}">
                    ...
                    <input type="time" id="initial_time" name="initial_time" value="{{ old('initial_time') }}" class="form-control" required>
        ...
        <div class="row">
            <div class="col-md-6">
                <div class="form-group {{ $errors->has('final_date') ? 'has-error' : '' }}">
                    ...
                    <input type="date" id="final_date" name="final_date" value="{{ old('final_date') }}" class="form-control" required>
            ...
            <div class="col-md-6">
                <div class="form-group {{ $errors->has('final_time') ? 'has-error' : '' }}">
                    ...
                    <input type="time" id="final_time" name="final_time" value="{{ old('final_time') }}" class="form-control" required>
